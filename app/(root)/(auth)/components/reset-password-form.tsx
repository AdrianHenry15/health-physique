      ...
      <motion.form
        ...
        <header className="mb-6">
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-center bg-linear-to-r from-green-600 to-green-400 dark:from-green-400 dark:to-green-200 bg-clip-text text-transparent drop-shadow">
              Reset Password
            </h1>
          </div>

      ...
      <section className="pt-32 pb-24 md:pb-32 max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4 pt-4">
            <Link
              href="/blog"
              className="px-6 py-3 bg-blue-600 text-white dark:bg-blue-500 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:bg-blue-700 dark:hover:bg-blue-600 transition">
              Read the Blog
            </Link>

            <Link
              href="/about"
              className="px-6 py-3 border border-gray-300 dark:border-gray-700 rounded-xl font-semibold hover:bg-gray-100 dark:hover:bg-gray-800 transition">
              Learn More
            </Link>
          </div>
        </div>
        ...
        <div className="relative group">
          <div className="absolute inset-0 rounded-3xl bg-linear-to-tr from-black/30 to-transparent dark:from-black/60 dark:to-transparent z-10 pointer-events-none transition-opacity duration-500"></div>
